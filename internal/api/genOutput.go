...
// PostGeographyAddJSONBody defines parameters for PostGeographyAdd.
type PostGeographyAddJSONBody struct {
	// Field The geography field to add.
	Field string `json:"field"`
}

// PostGeographyAddJSONRequestBody defines body for PostGeographyAdd for application/json ContentType.
type PostGeographyAddJSONRequestBody PostGeographyAddJSONBody
...
// PostGeographyAdd operation middleware
func (siw *ServerInterfaceWrapper) PostGeographyAdd(w http.ResponseWriter, r *http.Request) {
